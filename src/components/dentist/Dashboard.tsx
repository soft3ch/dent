    ...
    <div className="flex h-screen bg-surface font-body overflow-hidden">
      ...
      <aside className="w-64 fixed left-0 top-0 h-full hidden lg:flex flex-col bg-slate-50 dark:bg-slate-950 p-4 gap-2 z-40 border-r border-transparent">
        ...
        <nav className="flex-1 space-y-1 mt-4">
          <Link href="/dashboard" className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-800 text-blue-700 dark:text-blue-300 font-bold rounded-xl shadow-sm">
                          ...
                          return (
                            ...
                            >
                              <div className="flex flex-col h-full w-full justify-start overflow-hidden leading-tight">
                                ...
                                <p className="text-xs font-semibold text-slate-700 dark:text-slate-200 mt-0.5 truncate w-full">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className={`text-[10px] font-bold mt-0.5 ${app.payment_method === 'obra_social' ? 'text-sky-600' : 'text-emerald-600'
                          }`}>
                          {app.payment_method === 'obra_social' ? `Obra Social: ${app.insurance_name || 'N/A'}` : 'Particular'}
                        </p>
                      </div>
                    </div>
            ...
            <div className="bg-surface-container-low p-4 rounded-xl mb-6 space-y-3">
              ...
              {selectedAppointment.notes && (
                <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-sm font-medium text-black mt-1 italic">"{selectedAppointment.notes}"</p>
                </div>
              )}
            </div>
